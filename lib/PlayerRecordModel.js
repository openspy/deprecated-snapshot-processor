...
PlayerProgressModel.prototype.fetch = function(search_params) {
    return new Promise(function(resolve, reject) {
        ...
        this.collection.findOne(lookup_params, function(err, results) {
...
PlayerProgressModel.prototype.fetchMany = function(search_params) {
    return new Promise(function(resolve, reject) {
        var lookup_params = {};
        lookup_params = Object.assign(search_params, lookup_params);
        this.collection.find(lookup_params, function(err, results) {
            if(err) return reject(err);
            resolve(results || {});
        });
    }.bind(this));
